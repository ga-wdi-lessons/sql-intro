...
- Describe Domain Modeling and ERDs
...
need a way to fix this.. Enter data and databases!

### Data vs Behavior (15/20)
...
structure.
- Here's a diagram for an orchard, generated by the `rails-erd` gem.
...
#### You Do: Library ERD Example (10/30)
